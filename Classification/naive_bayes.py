...
# That Model can perform online updates to model parameters via .partial_fit() method
# Other models from naive_bayes package are BernoulliNB, MultinomialNB, ComplementNB
